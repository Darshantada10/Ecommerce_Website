...
<div class="col-xxl">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{url('/admin/product/update/'.$data->id)}}" method="POST" enctype="multipart/form-data" id="productForm">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" step="0.01" class="form-control" id="original_price" name="original_price" value="{{$data->original_price}}" required/>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" step="0.01" class="form-control" id="sale_price" value="{{$data->sale_price}}" name="sale_price"/>
                        @error('sale_price')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="sku" value="{{$data->sku}}" name="sku"/>
                        @error('sku')
                            <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        ...
                        @if ($data->image)
                        <img src="{{asset('storage/'.$data->image)}}" alt="Product Image" width="100" class="img-thumbnail rounded">
                        @endif
                        ...
                        <div class="gallery-container">
                            @foreach (json_decode($data->gallery) as $image)
                                <span class="d-inline-block m-1">
                                    <img src="{{asset('storage/'.$image)}}" alt="Product Image" width="100" class="img-thumbnail rounded">
                                </span>
                            @endforeach
                        </div>
                        @endif
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{$data->status == true ? 'checked' : ''}}>
                ...
                <div class="row mb-3">
                    <div class="col-sm-10 offset-sm-2">
                        <button type="button" class="btn btn-success" onclick="addAttribute()">+ Add Attribute</button>
                    </div>
                </div>
