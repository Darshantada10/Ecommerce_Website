                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="product-single__meta">
                        ...
                        <div class="prInfoRow">
                            ...
                            <div class="product-review"><a class="reviewLink" href="#tab2"><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star"></i><i class="font-13 fa fa-star-o"></i><i class="font-13 fa fa-star-o"></i></a></div>
                        </div>
                        <p class="product-single__price product-single__price-product-template">
                            ...
                            <span id="ProductPrice-product-template">
                                <span class="money">${{round($product->sale_price,2)}}</span>
                            </span>
                            @else
                            <s id="ComparePrice-product-template">
                                <span class="money">${{round($product->original_price,2)}}</span>
                            </s>
                            ...
                            <span class="discount-badge"> <span class="devider">|</span>&nbsp;
                                ...
                                <span class="money">${{$product->original_price - $product->sale_price}}</span>
                                </span>
